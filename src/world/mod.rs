...
pub use possession::{
    ...
    clear_item_from_body_slots, grasp_slot_available, is_carried_by, is_in_player_possession,
    place_in_grasp_slots, prune_creature_body_slots, prune_stale_body_slots, set_body_slot,
    PossessionError,
};
